...
6. **P1.6A blind pre-campaign freeze** — complete. All 102 cases are enabled;
   resources, single-attempt runner, pure deterministic analysis and G1 are
   frozen without a confirmatory solve.
...
frozen response-blind. All 102 cases are enabled, but P1.6A executed none and
created no confirmatory artifact. Stop before P1.6B.
